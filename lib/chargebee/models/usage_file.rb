module ChargeBee
  ...
  def self.upload_url(params, env=nil, headers={})
    ...
    options = {}
    Request.send('post', uri_path("usage_files","upload_url"), params, env, headers, "file-ingest", false, jsonKeys, options, "usageFile", "uploadUrl")
  end
  ...
  def self.processing_status(id, env=nil, headers={})
    ...
    options = {}
    Request.send('get', uri_path("usage_files",id.to_s,"processing_status"), {}, env, headers, "file-ingest", false, jsonKeys, options, "usageFile", "processingStatus")
  end
